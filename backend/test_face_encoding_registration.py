...
def test_register_with_sample_image():
    ...
    print("\n" + "="*80)
    print("TEST 7: Complete User Registration Test (should now be done via HR registration)")
    print("="*80)
    ...
    try:
        ...
        print(f"Registering test user (simulating HR registration)...")
        ...
        if result.get('success'):
            print(f"✅ User registered successfully (via HR)")
