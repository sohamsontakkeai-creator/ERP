...
class Leave(db.Model):
    ...
    manager_rejection_reason = db.Column(db.Text)
    hr_rejection_reason = db.Column(db.Text)
    approval_stage = db.Column(db.String(50), default='manager_review')
    ...
    def to_dict(self):
        ...
        return {
            ...
            'managerId': self.manager_id,
            'managerName': self.manager.full_name if self.manager else None,
            'managerStatus': self.manager_status,
            'managerApprovedAt': self.manager_approved_at.isoformat() if self.manager_approved_at else None,
            'managerRejectionReason': self.manager_rejection_reason,
            'hrRejectionReason': self.hr_rejection_reason,
